...
namespace HostApp
{
    ...
    public sealed partial class Welcome : Page
    {
        ...
        public static Welcome Current { get; private set; }
        public Welcome()
        {
            Current = this;
        ...
        private void OnLocateClick(object pSender, RoutedEventArgs pE)
        {
            _picker.SuggestedStartLocation = PickerLocationId.ComputerFolder;
            _picker.PickFolderAndContinue();
